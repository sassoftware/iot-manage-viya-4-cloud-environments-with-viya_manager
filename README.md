...
**tar -xzv Viya_Manager.tar.gz --dir=${HOME}**
...
- Viya 4 Manager
  ...
  Viya_Manager [ -h | -help ]
               [ -apply -cluster <cluster name> -provider <AZURE | AWS | GCP> [ -location <location> ] [ -credentials <file name> ] [ -template <file name> ] [ -v | -verbose ] ]
