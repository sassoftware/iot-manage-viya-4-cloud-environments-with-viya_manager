...
**tar -xzvf Viya_Manager.tar.gz [ --dir=${Viya_Manager root folder} ]**
...
- Viya 4 Manager
  ...
  Viya_Manager [ -h | -help ]
               ...
               [ -update -cluster <cluster name> -provider <AZURE | AWS | GCP | K8S> -order <order number> -cadence <Viya cadence> -type <LTS | STABLE> -email <email> [ -deploy ] [ -v | -verbose ] ]
  ...
  -update                                : Downloads a new copy of the Viya software order, including assets, license and certificates
...
- [-Update](./Options/Viya%20Installation/update_order.md)
